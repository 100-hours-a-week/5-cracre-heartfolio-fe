    ...
    <>
      <div id="my_modal_5" className="modal modal-bottom sm:modal-middle " open>
        <div className="modal-box text-center" style={{ width: "350px" }}>
          ...
          <p>가격 : {props.orderDetails.price.toLocaleString()} KRW</p>
          <p>총액 : {props.orderDetails.total.toLocaleString()} KRW</p>
    ...
    <>
      <div id="my_modal_5" className="modal modal-bottom sm:modal-middle " open>
        <div className="modal-box text-center" style={{ width: "350px" }}>
          ...
          <p>가격 : {props.sellDetails.price.toLocaleString()} KRW</p>
          <p>총액 : {props.sellDetails.total.toLocaleString()} KRW</p>
          <div className="modal-action">
            <button className="btn" onClick={props.onClick}>
              Close
            </button>
